...
path_to_lib = input_pickle[task_id][0][1]  # path to lib
lib = input_pickle[task_id][0][2]  # lib: LLM / Fragments
path_to_ctr = input_pickle[task_id][0][3]  # lib: LLM / Fragments


radius = "12.0"  # Optimal value. If needed, try increasing it
nruns = 25
path_to_data = "/slgpfs/projects/irb35/acomajuncosa/MurD/structures"
